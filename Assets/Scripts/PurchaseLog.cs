...
public class PurchaseLog : MonoBehaviour
{
    ...
    public static int AutoWoodUnlockAmount = 300;
    ...
    public static int AutoStoneUnlockAmount = 1000;
    public float InternalAutoStoneUnlockAmount;
    public static int AutoStoneWoodUnlockAmount = 700;
    ...
    public static int AddTimeUnlockAmount = 200;
    ...
    public static int StunSkillBuyUnlockAmount = 300;
    ...
    public static int MegaHitSkillBuyUnlockAmount = 500;
    ...
    public static int AddTimeSkillBuyUnlockAmount = 700;
